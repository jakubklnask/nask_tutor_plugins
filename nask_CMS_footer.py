"""
NASK Authoring Footer
Custom footer for authoring/studio MFE with help button for course creators.
Shows only on /authoring/home and /authoring/course/* pages.
"""
from tutor import hooks
from tutormfe.hooks import PLUGIN_SLOTS

PLUGIN_SLOTS.add_items([
    # Hide default footer in authoring MFE
    (
        "authoring",
    ...
    # Insert custom NASK authoring footer with help button
    (
        "authoring",
        "org.openedx.frontend.layout.footer.v1",
        """
        {
          ...
          widget: {
            id: 'custom_authoring_footer',
            type: DIRECT_PLUGIN,
            RenderWidget: ({ containerProps = {} }) => {
              const path = window.location.pathname;
              const showFooter = path === '/authoring/home' || path.includes('/authoring/course/');
              ...
              return (
                <footer 
                  className="py-3" 
                  style={{
                    backgroundColor: '#1B3961',
                    marginTop: 'auto',
                    width: '100%'
                  }}
                >
                  <div className={containerProps?.size === undefined ? 'container-fluid' : 'container'}>
                    <div className="row align-items-center mb-2">
                      ...
                      <div className="col-md-3">
                        ...
                        >
                          <img 
                            src="https://raw.githubusercontent.com/jakubklnask/openedx-nask-static-assets/refs/heads/nask-custom/open-edx-favicon.ico" 
                            alt="Help" 
                            style={{width: '20px', height: '20px', marginRight: '8px'}}
                          />
                          <span style={{fontSize: '0.95rem', fontWeight: '500', whiteSpace: 'nowrap'}}>
                            Jak tworzyć kursy? Pomoc
                          </span>
                        </a>
                      </div>
                    </div>
